...
const criteriaData = [
    { criteria: "Pertinence de la présentation", percentage: 80 },
    { criteria: "Concordance technique", percentage: 50 },
    { criteria: "Intêret des élèves", percentage: 20 },
    { criteria: "Qualité du support", percentage: 60 },
    { criteria: "Temps de présentation estimé", percentage: 80 }
];

const remarksData = Array(7).fill("Très intéressant. Lorem ipsum dolor sit amet...");

export function FeelingsAccompanying() {
    ...
    return (
        <div className="activity-rating-container">
            <h2>Note de l’activité par les Accompagnateurs</h2>
